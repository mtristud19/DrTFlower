...
{
    public abstract class DrTFlowerWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static DrTFlowerWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(DrTFlowerWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<DrTFlowerDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<DrTFlowerDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<DrTFlowerDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<DrTFlowerDbContext, Task<T>> func)
        {
            T result;
